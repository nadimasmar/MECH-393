...
if __name__ == "__main__":
    ...
    '''
    VOLUMES = {}
    for combination in acceptable_PG_combinations:
        test_case = combination #pick these from the previously generated acceptable_PG_combinations list 
        quality_index = 11
        pressure_angle = 20
        ...
        if True:
            for index in range(len(modules)):
                ...
                for stage in range(num_stages): #occurs once every stage
                    ...
                    plt.title("Pinion Safety Factor\n"+
                              ...
                              "\nStage = " + str(stage+1) +
                              "\nPinion Torque = " + str(round(test_pinion.torque, 1)) + " Nm" +
                              "; Gear Torque = " + str(round(test_gear.torque, 1)) + " Nm" +
            ...
            VOLUMES.update({combination:total_volume})
            print(VOLUMES)
