...
class baseStressCalculator:
    ...
    def torsion_stress(load, diameter, is_torque=True):
        ...
        J0 = np.pi * diameter ** 4 / 32 # mm^4
        if is_torque == True:
            return load * diameter / 2 / J0 # Nmm * mm / mm^4 = N/mm^2 = MPa
    ...
    @staticmethod
    def bending_stress(moment, diameter, outer=True): # N mm , mm
        ...
        I_zz = np.pi * diameter ** 4 / 64 # mm ^ 4
        sigma = moment * diameter / (I_zz * 2) # N / mm^2 = Nmm * mm / mm ^ 4
        if outer == True:
            return sigma # N/mm^2 = MPa
        elif outer == False:
            return -sigma
        else:
            raise TypeError("The optional parameter is_torque must be of type bool.")
